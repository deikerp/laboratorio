...
export class UserService {
    ...
    static async createUser(userData) {
        ...
        const query = `
            INSERT INTO usuario (
                usuario, contraseña, cedula, nombre, apellido, 
                celular, imagen, id_tipo
            ) 
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8) 
            RETURNING id_user, usuario, nombre, apellido, cedula, celular, imagen, id_tipo
        `;
    ...
    static async updateUser(id, userData) {
        ...
        query += ` WHERE id_user = $${paramIndex} RETURNING id_user, usuario, nombre, apellido, cedula, celular, imagen, id_tipo`;
        values.push(id);
